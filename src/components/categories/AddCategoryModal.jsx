...
function createHierarchicalOptions(categories, excludeId = null) {
  ...
  const addCategoryOptions = (category, level = 0) => {
    // Exclude edilecek kategoriyi atla
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">
                  Sistemde yeni bir kategori oluşturun
                </p>
              </div>
            </div>
            <button
          ...
          <div>
            ...
            <div className="relative">
              ...
              >
                ...
                {createHierarchicalOptions(categories).map((option) => (
          ...
          <div>
            ...
            <div className="flex items-center space-x-3">
              <input
                ...
                className="w-16 h-12 border border-gray-300 rounded-lg cursor-pointer focus:ring-2 focus:ring-green-500 focus:border-green-500 outline-none"
              />
              <input
                type="text"
                value={formData.color}
                ...
                className="flex-1 px-3 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 outline-none transition duration-200"
                placeholder="#3B82F6"
                pattern="^#[0-9A-Fa-f]{6}$"
              />
            </div>
